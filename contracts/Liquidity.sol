...
//         )
//         {
//             // for this exmaple, we will provide equal amount of liquidity in both assests.
//             // providing liquidity in both assets means liquidity will be earninh fees and is in-range.
...
//                     // We are providing Liquidiy across the whole range of the pool.
...
//                 });
//             // Note that the pool defined by DAI/USDC and fee tier 0.03% must
//             // already be created and intialized in order to mint
...
//             // Remobe allowance and refund in both assests.
...
//             // set amount0Max and amount1Max to uint256.max to collect all the fees.
//             // alternatively can be set recipient to msg,sender and avoid another transaction in `sendToOwner`
